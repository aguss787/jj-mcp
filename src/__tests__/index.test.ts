...
describe("Jujutsu MCP Server Tools", () => {
  ...
  test("jj_branch tool list action", async () => {
    ...
    expect(exec).toHaveBeenCalledWith("jj branch list", expect.any(Function));
  });
